...
const stats = computed(() => {
  const totalEngagement = myPosts.value.reduce(
    ...
    <div class="flex min-w-0">
      ...
      <div class="w-full min-w-0 flex-1 px-4 py-5 sm:px-6 lg:px-8">
        <div class="grid gap-6 2xl:grid-cols-[minmax(0,1fr)_320px]">
          <main class="min-w-0">
            <section
              class="mb-6 rounded-[18px] bg-white p-5 shadow-sm ring-1 ring-slate-200/70 sm:p-6"
            >
              <div class="flex flex-wrap items-start justify-between gap-4">
                <div class="min-w-0">
                  ...
                  <p class="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
                    Manage your active neighborhood updates and quick notices in the Oakwood Creek
                    circle.
                  </p>
                </div>
            ...
            <p
              v-if="loading"
              class="rounded-[18px] bg-white p-5 text-sm font-semibold text-slate-500 ring-1 ring-slate-200/70"
            >
              Loading your posts...
            </p>
            <p
            ...
            <section v-else class="grid auto-rows-fr gap-5 lg:grid-cols-2">
              ...
              >
                <div v-if="post.image" class="relative">
                  ...
                  />
                  <span
                    class="absolute left-4 top-4 rounded-full bg-white/95 px-3 py-1 text-xs font-black text-cyan-800 shadow-sm"
                  >
                    {{ post.category }}
                  </span>
                </div>
                ...
                <div class="p-5 sm:p-6">
                  <div class="flex items-start justify-between gap-4">
                    <div class="min-w-0">
                      <h2 class="text-lg font-black leading-tight text-slate-900">
                        {{ post.title }}
                      </h2>
                    ...
                    <div class="flex gap-2 shrink-0">
                      <button
                        class="rounded-full p-2 text-slate-400 transition hover:bg-slate-100 hover:text-cyan-800"
                      >
                  ...
                  <div
                    class="mt-5 flex flex-wrap items-center gap-4 text-xs font-semibold text-slate-500"
                  >
              ...
              >
                <span
                  class="flex h-12 w-12 items-center justify-center rounded-full bg-cyan-100 text-cyan-800"
                >
                  <Plus class="h-5 w-5" />
                </span>
                <span class="mt-4 text-sm font-black">New ephemeral post</span>
                <span class="mt-1 max-w-48 text-xs leading-5"
                  >Share a 24-hour update with nearby neighbors.</span
                >
              </RouterLink>
            </section>

            <section
              class="mt-6 rounded-[18px] bg-cyan-950 p-6 text-white shadow-lg shadow-cyan-950/15"
            >
              <div class="grid gap-5 md:grid-cols-[minmax(0,1fr)_auto] md:items-center">
                <div>
                  <p class="text-xs font-black uppercase tracking-[0.2em] text-cyan-100/70">
                    Your civic impact
                  </p>
                  <p class="mt-3 max-w-2xl text-sm leading-6 text-cyan-50/85">
                    In the last 30 days, your posts helped neighbors avoid road closures, recover
                    belongings, and discover nearby events.
                  </p>
                </div>
                <div class="grid grid-cols-3 gap-4 text-center">
                  <div>
                    ...
                    <p
                      class="text-[0.65rem] font-bold uppercase tracking-[0.16em] text-cyan-100/60"
                    >
                      Views
                    </p>
                  </div>
          ...
          <aside class="grid min-w-0 gap-5 md:grid-cols-2 2xl:block 2xl:space-y-5">
              ...
              <div class="mt-4 space-y-4">
                ...
                <article class="rounded-2xl bg-slate-50 p-4">
                  ...
                  <p class="mt-2 text-xs leading-5 text-slate-500">
                    Elm Street delays expected this evening.
                  </p>
                </article>
              </div>
            </section>
            ...
            <section class="rounded-[18px] bg-white p-5 shadow-sm ring-1 ring-slate-200/70">
              ...
              <p class="mt-4 text-xs leading-5 text-slate-500">
                Your repair notice is useful because it includes time, place, and a clear action for
                neighbors.
              </p>
            </section>
          </aside>
